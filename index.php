...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.jpg" alt="GAURAV" width="400" height="300">
        <p><strong>GAURAV PANDEY</strong></p>
        <p>BIT 2nd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profile.jpg" alt="ABHINAV" width="400" height="300">
        <p><strong>ABHINAV V</strong></p>
        <p>BIT 2nd year BTECH</p>
      </div>
    </div>
